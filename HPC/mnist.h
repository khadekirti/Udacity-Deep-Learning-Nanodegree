...
int  train_label_[NUM_TRAIN];
int test_label_[NUM_TEST];
int  train_label[NUM_TRAIN][10];
int test_label[NUM_TEST][10]; 
...
void label_vectorise(int num_data , int data_label_[], int data_label[][10] )
{
    int i,j ; 
...
void load_mnist()
{
    ...
    label_char2int(NUM_TRAIN, train_label_char, train_label_);
    label_vectorise(NUM_TRAIN , train_label_, train_label); 
 
    read_mnist_char(TEST_LABEL, NUM_TEST, LEN_INFO_LABEL, 1, test_label_char, info_label);
    label_char2int(NUM_TEST, test_label_char, test_label_);
    label_vectorise(NUM_TRAIN , test_label_, test_label); 
